...
public class MimeHeaders
     ...
     * @throws IOException if the input stream throws an IOException while being
     * read.
     */
    public void
     ...
     *
     * @param    in The input stream to read from.
     * @param    shouldReplace If true, existing keys are replaced instead of
     * augmented.
     * @throws IOException if the input stream throws an IOException while being
     * read.
     ...
     *
     * @param    other The <code>MimeHeaders</code> object to copy to.
     */
    public void
