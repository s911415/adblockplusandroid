...
public class HttpUtil {
     ...
     *
     * @param    time The date to format (current time in msec).
     ...
     *
     * @param        time A correctly formatted HTTP date string.
     ...
     *
     * @param    query The x-www-form-urlencoded string.  May be <code>null</code>
     * @param    table The dictionary to insert the form data into.
     */
    public static void
