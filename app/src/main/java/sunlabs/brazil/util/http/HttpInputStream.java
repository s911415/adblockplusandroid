...
public class HttpInputStream
     ...
     *
     * @param    buf Buffer in which the data is stored.  If buffer is of
     ...
     * it is important to read the exact number of bytes desired.
     *
     * @param    buf Buffer in which the data is stored.
     * @param    off The starting offset into the buffer.
     ...
     *
     * @param    out The output stream to copy the data to.
     * @param    len The number of bytes to copy, or < 0 to copy until the end
     * of this stream.
     * @return The number of bytes copied to the output stream.
     * @throws IOException if the underlying input stream throws an
     * IOException while being read or if the output stream
     ...
     * @param    len The number of bytes to copy, or < 0 to copy until the end
     * of this stream.
     * @param    buf The buffer used to for holding the temporary results while
