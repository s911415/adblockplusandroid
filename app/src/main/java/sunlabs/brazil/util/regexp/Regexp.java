...
public class Regexp
     ...
     *
     * @param    pat The string holding the regular expression pattern.
     ...
     *
     * @param    pat The string holding the regular expression pattern.
     * @param    ignoreCase If <code>true</code> then this regular expression will
     ...
     *
     * @param    rs Information about the matched region.
     * @param    subspec The substitution parameter.
     * @param    sb StringBuffer to which the generated string is appended.
     */
    public static void
     ...
     *
     * @param    str The string to match.
     * @param    substrs An array of strings allocated by the caller, and filled in
     ...
     *
     * @param    str The string to match.
     * @param    indices An array of integers allocated by the caller, and filled in
     * with information about the portions of <code>str</code> that
     ...
     * @param    subspec The substitution parameter, described in <a href=#regsub>
...
*/
    ...
    public interface Filter {
         ...
         * </pre>
         *
         * @param rs <code>Regsub</code> containing the state of the current
         *           match.
         * @param sb The string buffer that this filter should append the
