...
public interface Handler {
     ...
     *
     * @param    server The HTTP server that created this <code>Handler</code>.
     * Typical <code>Handler</code>s will use {@link Server#props}
     * to obtain run-time configuration information.
     * @param    prefix The handlers <i>name</i>.
     ...
     *
     * @param    request The <code>Request</code> object that represents the HTTP
     * request.
