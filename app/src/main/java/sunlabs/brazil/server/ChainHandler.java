...
public class ChainHandler
     ...
     *
     * @param    server The HTTP server that created this <code>ChainHandler</code>.
     * @param    prefix The prefix for this <code>ChainHandler</code>'s properties.
     ...
     * @throws IOException if one of the <code>Handler</code>s throws an
